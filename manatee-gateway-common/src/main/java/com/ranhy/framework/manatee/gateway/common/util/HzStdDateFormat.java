...
/**
 * 代码复制StdDateFormat类
 * 主要修改时区DEFAULT_TIMEZONE = TimeZone.getTimeZone("GMT+8");
 */
public class HzStdDateFormat extends DateFormat {
    ...
    private static final long serialVersionUID = 7918659395535717699L;
     ...
     */
    public final static HzStdDateFormat instance = new HzStdDateFormat();
    ...
    public HzStdDateFormat() {
    }

    public HzStdDateFormat(TimeZone tz) {
	_timezone = tz;
    }
     ...
     */
    public HzStdDateFormat withTimeZone(TimeZone tz) {
	if (tz == null) {
	    tz = DEFAULT_TIMEZONE;
	}
	return new HzStdDateFormat(tz);
    }

    @Override
    public HzStdDateFormat clone() {
        /* Although there is that much state to share, we do need to
         * orchestrate a bit, mostly since timezones may be changed
         */
	return new HzStdDateFormat();
    }
